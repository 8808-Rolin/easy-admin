<template>
  <div style="padding:30px;">
    <el-alert :closable="false" title="审核历史" />
    <div class="table">
      <el-table :data="apply" fit style="width: 100%">
        ...
        <el-table-column label="状态" width="150">
          <template slot-scope="scope">
            <el-tag type="success" size="medium" v-show="scope.row.status === 1">通&emsp;过</el-tag>
            <el-tag type="danger" size="medium" v-show="scope.row.status === 2">未通过</el-tag>
          </template>
        </el-table-column>
      </el-table>
    </div>
