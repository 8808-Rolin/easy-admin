  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <el-form-item prop="username">
        ...
        <el-input ref="username" v-model="loginForm.username" placeholder="教工号" name="username" type="text" tabindex="1"
          auto-complete="on" />
      </el-form-item>
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;font-size: 1.125rem;"
  ...
  export default {
    ...
    beforeMount() {
      if (this.studentID !== null || this.studentID !== '')
        this.loginForm.username = this.studentID
    }
  }
</script>
