<template>
  <div style="padding:30px;">
    ...
    <div class="table">
      <el-table :data="members" height="550" fit style="width: 100%">
        ...
        <el-table-column label="操作" width="150">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" @click="setAssAdmin(scope.row.uid, 1)" v-show="scope.row.is_admin == 0">设为管理员</el-button>
            <el-button type="danger" size="mini" @click="setAssAdmin(scope.row.uid, 0)" v-show="scope.row.is_admin == 1">罢免管理员</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
